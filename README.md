...
**IMOIRTANTE**: No se recomienda entrenar la EfficientNetV2, a menos que se disponga de una GPU CUDA (NVIDIA) debido al elevado tiempo. Si se quiere probar que funciona el script, hágalo con : `python scripts/train_model.py BaselineModel 100`. Se pueden reducir las epochs si con 100 aún nota demora.
